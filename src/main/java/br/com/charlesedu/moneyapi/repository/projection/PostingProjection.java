package br.com.charlesedu.moneyapi.repository.projection;
...
public class PostingProjection {
    ...
    public PostingProjection(Long id, String postingDescription, LocalDate dueDate, LocalDate paymentDate,
            BigDecimal postingValue, PostingType postingType, String category, String person) {
        this.id = id;
